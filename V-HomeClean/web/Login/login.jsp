    ...
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
              <h3>Login to <strong style="color: #f8e43c">V-Cleaning</strong></h3>
<!--            <p class="mb-4">Lorem ipsum dolor sit amet elit. Sapiente sit aut eos consectetur adipisicing.</p>-->
            <form action="#" method="post">
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <input style="color: white; background-color:  #309cf4; border: none;" type="submit" value="Log In" class="btn btn-block btn-primary">
              <input style="color: white; background-color:  #309cf4; border: none;" type="submit" value="Register" class="btn btn-block btn-primary">
