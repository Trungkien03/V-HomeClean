        ...
        <jsp:include page="navigation.jsp"></jsp:include>
            ...
            <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
                <div class="container text-center py-5">
                    <h1 class="display-4 text-white animated slideInDown mb-4">Blog Title Here</h1>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 mb-5">
                                    <div class="blog-item">
                                        <img src="img/blog1.jpg" alt="" class="img-fluid rounded">
                                ...
                                <div class="col-lg-6 col-md-6 mb-5">
                                    <div class="blog-item">
                                        <img src="img/blog2.jpg" alt="" class="img-fluid rounded">
                                        ...
                                        <div class="blog-item-content bg-white p-4">
                                            ...
                                            <h3 class="mt-3 mb-3"><a href="#">Interactivity connect consumer</a></h3>
                                            <p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
                                ...
                                <div class="col-lg-6 col-md-6 mb-5">
                                    <div class="blog-item">
                                        <img src="img/blog3.jpg" alt="" class="img-fluid rounded">
                                        ...
                                        <div class="blog-item-content bg-white p-4">
                                            ...
                                            <h3 class="mt-3 mb-3"><a href="#">Marketing Strategy to bring more affect</a></h3>
                                            <p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur accusantium pariatur repudiandae!</p>
                                ...
                                <div class="col-lg-6 col-md-6 mb-5">
                                    <div class="blog-item">
                                        <img src="img/blog4.jpg" alt="" class="img-fluid rounded">
