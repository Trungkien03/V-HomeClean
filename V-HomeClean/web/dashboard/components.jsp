<%-- 
    Document   : components
    Created on : May 28, 2023, 11:28:43 PM
    Author     : Trung Kien
--%>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <a href="#" class="alert-link">problem</a> has been
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p class="card-text">
                                            ...
                                            <code>.btn</code> class to get Rounded button
                                        </p>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <ul
                                                    class="nav nav-tabs nav-tabs-solid nav-tabs-rounded"
                                                    >
                                                    <li class="nav-item">
                                                        <a
                                                            class="nav-link active"
                                    ...
                                    <div class="col-md-4 d-flex">
                                        <div class="card flex-fill">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p>
                                                    <a href="#" class="text-white bg-dark mb-0"
                                                       >White link</a
                                                    >
                                                </p>
                                            </div>
