<%-- 
    Document   : ui-images
    Created on : May 21, 2023, 9:55:08 PM
    Author     : Trung Kien
--%>
                            ...
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="images/paris.jpg" class="img-rounded img-fluid" alt="Cinque Terre">
                                    </div>
                                </div>
                            </div>
                            <!-- /# column -->
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="images/newyork.jpg" class="img-circle img-fluid" alt="Cinque Terre">
                                    </div>
                                </div>
                            </div>
                            <!-- /# column -->
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="images/sanfran.jpg" class="img-thumbnail img-fluid" alt="Cinque Terre">
                                    </div>
                                </div>
                            </div>
                            <!-- /# column -->
                            <div class="col-lg-3">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="images/lights.jpg" class=" img-fluid" alt="Cinque Terre">
                                    </div>
                                </div>
                            </div>
                            <!-- /# column -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="images/lights.jpg">
                                                        <img class="w-100" src="images/lights.jpg" alt="Lights">
                                                        <div class="caption">
                                            ...
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="images/nature.jpg">
                                                        <img class="w-100" src="images/nature.jpg" alt="Nature">
                                                        <div class="caption">
                                                            <p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>
                                                        </div>
                                                    </a>
                                            ...
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="images/fjords.jpg">
                                                        <img class="w-100" src="images/fjords.jpg" alt="Fjords">
                                                        <div class="caption">
                                                            <p>Lorem ipsum donec id elit non mi porta gravida at eget metus.</p>
                                                        </div>
                                                    </a>
