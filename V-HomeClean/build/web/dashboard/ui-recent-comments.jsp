<%-- 
    Document   : ui-recent-comments
    Created on : May 21, 2023, 9:57:46 PM
    Author     : Trung Kien
--%>
...
<html lang="en">
    ...
    <body>
                                    ...
                                    <div class="recent-comment">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="images/user-1.png" alt="..."></a>
                                            </div>
        ...
        <script src="js/lib/chart-js/custom-chart-js.js"></script>
