...
public final class create_002dbooking_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("                                    <form action=\"ServiceCreateController\" method=\"post\" enctype=\"multipart/form-data\">\n");
      ...
      out.write("                                                    <option disabled selected>-- Chọn --</option>\n");
      out.write("                                                    <option value=\"2\">Dịch vụ sửa chữa</option>\n");
      out.write("                                                    <option value=\"1\">Dịch vụ dọn dẹp</option>                                 \n");
      out.write("                                                </select>\n");
      out.write("                                            </div>\n");
      out.write("                                            <div id=\"error-message\" class=\"text-center\" style=\"display: none; color: red;\"></div>\n");
      out.write("                                        </div>\n");
      out.write("                                        <div class=\"form-group row\">\n");
      ...
      out.write("                                            <div>\n");
      out.write("                                                <input class=\"btn btn-primary w-25\" type=\"submit\" name=\"action\" value=\"Tạo mới dịch vụ\"/>\n");
      out.write("                                            </div>\n");
      out.write("                                        </div>\n");
      out.write("\n");
      out.write("                                    </form>\n");
      ...
      out.write("            var selectedValue = $('select[name=\"serviceType\"]').val();\n");
      out.write("            if (!selectedValue) {\n");
      out.write("                e.preventDefault();\n");
      out.write("                $('#error-message').text('Vui lòng chọn một giá trị cho trường Thể loại.').show();\n");
      out.write("            } else {\n");
      out.write("                $('#error-message').hide();\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("</script>\n");
